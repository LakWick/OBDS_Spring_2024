...
# featurecounts
featureCounts -p --countReadPairs -t exon -T 12 -B -C -s 2 -g gene_id -a ./genome/Mus_musculus.GRCm38.102.gtf.gz -o ./quantification/ERR1755082sorted_featureCounts_output.txt \
./mapped_reads/ERR1755082sorted.bam
