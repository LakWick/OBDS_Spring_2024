...
samtools view --threads 12 -bh ./mapped_reads/ERR1755082.sam > ./mapped_reads/ERR1755082.bam 
samtools sort ./mapped_reads/ERR1755082.bam > ./mapped_reads/ERR1755082sorted.bam
samtools index ./mapped_reads/ERR1755082sorted.bam
