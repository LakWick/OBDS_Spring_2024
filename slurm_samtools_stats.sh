...
samtools idxstats --threads 2 ./mapped_reads/ERR1755082sorted.bam > ./mapped_reads/ERR1755082sorted.idxstats
samtools flagstat ./mapped_reads/ERR1755082sorted.bam > ./mapped_reads/ERR1755082sorted.flagstat
